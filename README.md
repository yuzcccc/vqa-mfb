...
| VQA-2.0   | 62.33%[^mcb]  |65.09% [BaiduYun](http://pan.baidu.com/s/1pLjtkSV)   | 66.12% [BaiduYun](http://pan.baidu.com/s/1pLLUvIN) or [Dropbox](https://www.dropbox.com/s/zld15405a69how6/VQA2.0-mfh-coatt-glove-vg.zip?dl=0) | **68.78%**[^mfh] |
[^mcb]: the MCB result on VQA-2.0 is provided by the VQA Challenge organizer

[^mfh]: this model is trained without the VG dataset. We observe the fact that introducing VG here does not bring performance improvement 
